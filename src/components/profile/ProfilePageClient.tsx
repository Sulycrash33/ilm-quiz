        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <PremiumStat label="Total XP" value={profile.totalXp.toLocaleString()} />
              <PremiumStat label="Day Streak" value={profile.streakCount} />
              <PremiumStat label="Global Rank" value={globalRank ? `#${globalRank}` : "—"} />
              <PremiumStat label="Accuracy" value={totalAttempts > 0 ? `${accuracyPct}%` : "—"} />
            </div>
      ...
      <AnimatePresence mode="wait">
        ...
        {activeTab === "activity" && (
          <motion.div key="activity" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}>
            <PremiumCard className="p-6">
              <h3 className="font-headline-md text-headline-md text-primary mb-4">Your Recent Activity</h3>
