    ...
    <div className="min-h-screen px-5 py-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-on-surface-variant mb-4">
            Complete today&apos;s special challenge for bonus rewards. Limited time only!
          </p>
          <div className="flex items-center gap-4 mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-tertiary">+500 XP</span>
            </div>
            <PremiumBadge variant="primary" size="sm">3x XP Multiplier</PremiumBadge>
          </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {gameModes.map((mode, index) => (
            ...
            >
              <PremiumCard hover className="p-6 h-full">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <PremiumBadge variant={mode.color as "primary" | "secondary" | "tertiary" | "success" | "warning"} size="sm">
                    {mode.difficulty}
                  </PremiumBadge>
                </div>
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center">
            <p className="font-bold text-3xl text-primary">1,247</p>
            <p className="font-label-caps text-label-caps text-on-surface-variant">QUESTIONS</p>
          </div>
          <div className="text-center">
            <p className="font-bold text-3xl text-secondary">87%</p>
            <p className="font-label-caps text-label-caps text-on-surface-variant">ACCURACY</p>
          </div>
          <div className="text-center">
            <p className="font-bold text-3xl text-tertiary">42h</p>
            <p className="font-label-caps text-label-caps text-on-surface-variant">STUDY TIME</p>
          </div>
          <div className="text-center">
            <p className="font-bold text-3xl text-primary-fixed">8,420</p>
