...
export const STORE_ITEMS: StoreItems = {
  lifelines: [
    ...
    { id: 13, name: "Reveal Answer", description: "Instantly reveals the correct answer for a question.", icon: "💡", price: 300, inStock: true },
  ],
  powerups: [
    ...
    { id: 14, name: "Category XP Boost", description: "Earn 2x XP for a specific category for 24 hours.", icon: "📈", price: 350, inStock: true },
  ],
  cosmetics: [
    ...
    { id: 15, name: "Calligraphy Banner", description: "A profile banner with stunning calligraphy.", icon: "📜", price: 350, inStock: true },
    { id: 16, name: "Luminous Effect", description: "A subtle glowing effect for your avatar.", icon: "✨", price: 600, inStock: true },
  ],
  bundles: [
    {
      id: 1,
    ...
    },
    {
      ...
      description: "Begin customizing your profile with these popular items.",
      icon: "🎨",
      price: 700,
      originalPrice: 950,
      items: ["Starry Background", "Calligraphy Badge", "Calligraphy Banner"],
    },
  ],
};
