...
const haTranslations: Translations = {
  ...
  score: "Maki",
  accuracy: "Daidaito",
  narratedBy: "An ruwaito daga {narrator}",
  ...
  hostQuiz: "Karɓi Bakuncin Jarabawa ga Abokanka",
  ...
  // Rewards
  rewardsCenter: "Cibiyar Lada",
  claimRewards: "Karɓi Ladanka Ka Gwada Sa'arka",
  ...
  dayLabel: "Rana {day}",
  claimedForToday: "An Karɓa don Yau",
  claimingLabel: "Ana Karɓa...",
