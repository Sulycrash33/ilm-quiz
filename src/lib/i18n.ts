...
export interface Translations {
  ...
  /** The password reset flow. `forgotPassword` was translated into all six
   * locales long before this existed and nothing ever rendered it, so the
   * label was there and the route was not. */
  resetTitle: string
  resetIntro: string
  sendResetLink: string
  resetLinkSentTitle: string
  resetLinkSentBody: string
  couldntSendResetLink: string
  backToSignIn: string
  newPasswordTitle: string
  newPasswordIntro: string
  ...
  couldntUpdatePassword: string
  resetLinkInvalidTitle: string
  resetLinkInvalidBody: string
  requestNewResetLink: string
  checkingResetLink: string
  ...
  howItWorksLadderTitle: string
  howItWorksLadderBody: string
  howItWorksClearingTitle: string
  howItWorksClearingBody: string
  howItWorksRuleAll: string
  howItWorksRuleRetry: string
  ...
  roundReviewCorrectAnswer: string
  roundReviewNotAnswered: string
  roundReviewTimedOutNote: string
  roundReviewShow: string
  roundReviewHide: string
  ...
  /** Small caps label above each intro panel title. */
  introEyebrowOne: string
  introTitleOne: string
  introBodyOne: string
  introEyebrowTwo: string
  introTitleTwo: string
  introBodyTwo: string
  introEyebrowThree: string
  /** Takes {first} and {last}: the first and last rank titles, read from
   *  RANKS so the copy cannot drift from the ladder it describes. */
  introTitleThree: string
  introBodyThree: string
  /** The call to action on the final intro panel. */
  introEnter: string
  /** The unit word alone. The count is rendered beside it at display
   *  size, so the string must not carry the numeral itself. */
  introSubjectsWord: string
...
const enTranslations: Translations = {
  ...
  resetIntro: "Enter the email you signed up with. If an account exists, we will send you a link to set a new password.",
  sendResetLink: "Send reset link",
  resetLinkSentTitle: "Check your email",
  resetLinkSentBody: "If an account exists for that address, a link to set a new password is on its way. The link expires in an hour.",
  couldntSendResetLink: "Couldn't send the reset link",
  backToSignIn: "Back to sign in",
  newPasswordTitle: "Set a new password",
  newPasswordIntro: "Choose a new password for your account. You will be signed in once it is saved.",
  ...
  passwordUpdatedBody: "You are signed in.",
  couldntUpdatePassword: "Couldn't update your password",
  resetLinkInvalidTitle: "This link has expired",
  resetLinkInvalidBody: "A reset link can only be used once, and it stops working an hour after it is sent.",
  requestNewResetLink: "Request a new link",
  checkingResetLink: "Checking your link",
  ...
  storyModeDesc: "A guided path through the Quran, then the Hadith, then the lives of the Sahaba.",
  ...
  howItWorksLadderTitle: "Nine levels, one category at a time",
  howItWorksLadderBody: "Every category is a ladder of nine levels, from Mubtadi to Mujaddid. Level 1 is open. The other eight are locked until you earn them.",
  howItWorksClearingTitle: "Clear a level to open the next",
  howItWorksClearingBody: "Level 1 holds {count} questions. The next level opens only when you have answered every one of them correctly.",
  howItWorksRuleAll: "All {count} questions, answered correctly",
  howItWorksRuleRetry: "Miss one and you can run the level again, as often as you like",
  ...
  roundReviewCorrectAnswer: "Correct answer",
  roundReviewNotAnswered: "Not answered",
  roundReviewTimedOutNote: "The clock ran out, so this one was never graded. The answer is not shown.",
  roundReviewShow: "Review all questions",
  roundReviewHide: "Hide the review",
  ...
  introEyebrowThree: "The rank",
  introTitleThree: "From {first} to {last}",
  introBodyThree: "Nine ranks stand between them, earned one level at a time. And every answer tells you why, right or wrong. You never just lose here. You learn.",
  introEnter: "Begin the hunt",
  introSubjectsWord: "subjects",
...
const msTranslations: Translations = {
  ...
  resetIntro: "Masukkan e-mel yang anda daftar. Jika akaun wujud, kami akan hantar pautan untuk menetapkan kata laluan baharu.",
  sendResetLink: "Hantar pautan",
  resetLinkSentTitle: "Semak e-mel anda",
  resetLinkSentBody: "Jika akaun wujud untuk alamat itu, pautan untuk menetapkan kata laluan baharu sedang dihantar. Pautan itu tamat dalam satu jam.",
  couldntSendResetLink: "Tidak dapat menghantar pautan",
  backToSignIn: "Kembali ke log masuk",
  newPasswordTitle: "Tetapkan kata laluan baharu",
  newPasswordIntro: "Pilih kata laluan baharu untuk akaun anda. Anda akan log masuk sebaik ia disimpan.",
  newPasswordLabel: "Kata laluan baharu",
  confirmPasswordLabel: "Sahkan kata laluan baharu",
  savePassword: "Simpan kata laluan",
  passwordsDoNotMatch: "Dua kata laluan itu tidak sama.",
  passwordTooShort: "Gunakan sekurang-kurangnya 6 aksara.",
  passwordUpdatedTitle: "Kata laluan dikemas kini",
  passwordUpdatedBody: "Anda sudah log masuk.",
  couldntUpdatePassword: "Tidak dapat mengemas kini kata laluan",
  resetLinkInvalidTitle: "Pautan ini telah tamat",
  resetLinkInvalidBody: "Pautan tetapan semula hanya boleh digunakan sekali, dan ia berhenti berfungsi satu jam selepas dihantar.",
  requestNewResetLink: "Minta pautan baharu",
  checkingResetLink: "Menyemak pautan anda",
  ...
  storyModeDesc: "Laluan berpandu menerusi al-Quran, kemudian Hadis, kemudian kehidupan para Sahabat.",
  ...
  howItWorksLadderTitle: "Sembilan tahap, satu kategori pada satu masa",
  howItWorksLadderBody: "Setiap kategori ialah tangga sembilan tahap, dari Mubtadi hingga Mujaddid. Tahap 1 terbuka. Lapan yang lain berkunci sehingga anda melayakkannya.",
  howItWorksClearingTitle: "Habiskan satu tahap untuk membuka yang seterusnya",
  howItWorksClearingBody: "Tahap 1 mengandungi {count} soalan. Tahap seterusnya hanya terbuka apabila anda menjawab kesemuanya dengan betul.",
  howItWorksRuleAll: "Kesemua {count} soalan, dijawab dengan betul",
  howItWorksRuleRetry: "Tersilap satu? Ulang tahap itu, seberapa kerap yang anda mahu",
  ...
  roundReviewCorrectAnswer: "Jawapan betul",
  roundReviewNotAnswered: "Tidak dijawab",
  roundReviewTimedOutNote: "Masa habis, jadi soalan ini tidak dinilai. Jawapannya tidak ditunjukkan.",
  roundReviewShow: "Semak semua soalan",
  roundReviewHide: "Sembunyikan semakan",
  ...
  introEyebrowThree: "Pangkat",
  introTitleThree: "Dari {first} ke {last}",
  introBodyThree: "Sembilan pangkat memisahkan keduanya, diraih satu tahap pada satu masa. Dan setiap jawapan memberitahu anda sebabnya, betul atau salah. Anda tidak sekadar kalah di sini. Anda belajar.",
  introEnter: "Mulakan perburuan",
  introSubjectsWord: "subjek",
...
const idTranslations: Translations = {
  ...
  resetIntro: "Masukkan email yang Anda pakai mendaftar. Jika akunnya ada, kami akan mengirim tautan untuk membuat kata sandi baru.",
  sendResetLink: "Kirim tautan",
  resetLinkSentTitle: "Periksa email Anda",
  resetLinkSentBody: "Jika ada akun untuk alamat itu, tautan untuk membuat kata sandi baru sedang dikirim. Tautan itu kedaluwarsa dalam satu jam.",
  couldntSendResetLink: "Tidak dapat mengirim tautan",
  backToSignIn: "Kembali ke masuk",
  newPasswordTitle: "Buat kata sandi baru",
  newPasswordIntro: "Pilih kata sandi baru untuk akun Anda. Anda akan langsung masuk setelah disimpan.",
  newPasswordLabel: "Kata sandi baru",
  confirmPasswordLabel: "Konfirmasi kata sandi baru",
  savePassword: "Simpan kata sandi",
  passwordsDoNotMatch: "Kedua kata sandi tidak sama.",
  passwordTooShort: "Gunakan minimal 6 karakter.",
  passwordUpdatedTitle: "Kata sandi diperbarui",
  passwordUpdatedBody: "Anda sudah masuk.",
  couldntUpdatePassword: "Tidak dapat memperbarui kata sandi",
  resetLinkInvalidTitle: "Tautan ini sudah kedaluwarsa",
  resetLinkInvalidBody: "Tautan atur ulang hanya bisa dipakai sekali, dan berhenti berlaku satu jam setelah dikirim.",
  requestNewResetLink: "Minta tautan baru",
  checkingResetLink: "Memeriksa tautan Anda",
  ...
  storyModeDesc: "Jalur terpandu melalui Al-Qur'an, lalu Hadis, lalu kehidupan para Sahabat.",
  ...
  howItWorksLadderTitle: "Sembilan tingkat, satu kategori sekaligus",
  howItWorksLadderBody: "Setiap kategori adalah tangga sembilan tingkat, dari Mubtadi hingga Mujaddid. Tingkat 1 terbuka. Delapan sisanya terkunci sampai kamu meraihnya.",
  howItWorksClearingTitle: "Selesaikan satu tingkat untuk membuka berikutnya",
  howItWorksClearingBody: "Tingkat 1 berisi {count} soal. Tingkat berikutnya baru terbuka setelah kamu menjawab semuanya dengan benar.",
  howItWorksRuleAll: "Semua {count} soal, dijawab benar",
  howItWorksRuleRetry: "Salah satu? Ulangi tingkatnya, sesering yang kamu mau",
  ...
  roundReviewCorrectAnswer: "Jawaban benar",
  roundReviewNotAnswered: "Tidak dijawab",
  roundReviewTimedOutNote: "Waktu habis, jadi soal ini tidak dinilai. Jawabannya tidak ditampilkan.",
  roundReviewShow: "Tinjau semua soal",
  roundReviewHide: "Sembunyikan tinjauan",
  ...
  introEyebrowThree: "Peringkat",
  introTitleThree: "Dari {first} ke {last}",
  introBodyThree: "Sembilan peringkat memisahkan keduanya, diraih satu level demi satu level. Dan setiap jawaban memberi tahu Anda alasannya, benar atau salah. Anda tidak sekadar kalah di sini. Anda belajar.",
  introEnter: "Mulai perburuan",
  introSubjectsWord: "subjek",
...
const haTranslations: Translations = {
  ...
  resetIntro: "Ka shigar da imel ɗin da ka yi rajista da shi. Idan akwai asusu, za mu aika maka hanyar saita sabuwar kalmar sirri.",
  sendResetLink: "Aika hanyar",
  resetLinkSentTitle: "Duba imel ɗinka",
  resetLinkSentBody: "Idan akwai asusu na wannan adireshin, ana aika hanyar saita sabuwar kalmar sirri. Hanyar tana ƙarewa cikin awa ɗaya.",
  couldntSendResetLink: "An kasa aika hanyar",
  backToSignIn: "Koma shiga",
  newPasswordTitle: "Saita sabuwar kalmar sirri",
  newPasswordIntro: "Ka zaɓi sabuwar kalmar sirri don asusunka. Za ka shiga da zarar an ajiye ta.",
  newPasswordLabel: "Sabuwar kalmar sirri",
  confirmPasswordLabel: "Tabbatar da sabuwar kalmar sirri",
  savePassword: "Ajiye kalmar sirri",
  passwordsDoNotMatch: "Kalmomin sirri biyu ba iri ɗaya ba ne.",
  passwordTooShort: "Ka yi amfani da haruffa 6 aƙalla.",
  passwordUpdatedTitle: "An sabunta kalmar sirri",
  passwordUpdatedBody: "Ka riga ka shiga.",
  couldntUpdatePassword: "An kasa sabunta kalmar sirri",
  resetLinkInvalidTitle: "Wannan hanyar ta ƙare",
  resetLinkInvalidBody: "Ana amfani da hanyar sake saitawa sau ɗaya kawai, kuma tana daina aiki awa ɗaya bayan an aika ta.",
  requestNewResetLink: "Nemi sabuwar hanya",
  checkingResetLink: "Ana duba hanyarka",
  ...
  storyModeDesc: "Hanya mai jagora ta Alƙur'ani, sannan Hadisi, sannan rayuwar Sahabbai.",
  ...
  howItWorksLink: "Yadda wasan ke tafiya",
  howItWorksLadderTitle: "Matakai tara, kashi ɗaya bayan ɗaya",
  howItWorksLadderBody: "Kowane kashi tsani ne na matakai tara, daga Mubtadi zuwa Mujaddid. Mataki na 1 a buɗe yake. Sauran takwas a kulle suke har sai ka cancance su.",
  howItWorksClearingTitle: "Kammala mataki don buɗe na gaba",
  howItWorksClearingBody: "Mataki na 1 yana da tambayoyi {count}. Mataki na gaba ba ya buɗewa sai ka amsa dukkansu daidai.",
  howItWorksRuleAll: "Dukkan tambayoyi {count}, an amsa su daidai",
  howItWorksRuleRetry: "Ka kuskure ɗaya? Ka sake matakin, sau nawa ka so",
  ...
  roundReviewCorrectAnswer: "Amsar da ta dace",
  roundReviewNotAnswered: "Ba a amsa ba",
  roundReviewTimedOutNote: "Lokaci ya ƙare, don haka ba a kimanta wannan ba. Ba a nuna amsar ba.",
  roundReviewShow: "Duba dukan tambayoyi",
  roundReviewHide: "Ɓoye dubawar",
  ...
  introEyebrowThree: "Matsayi",
  introTitleThree: "Daga {first} zuwa {last}",
  introBodyThree: "Matsayi tara ne tsakaninsu, ana samun su mataki bayan mataki. Kuma kowace amsa tana gaya maka dalilin, daidai ko kuskure. Ba kawai ka yi rashin nasara ba a nan. Kana koyo.",
  introEnter: "Fara farauta",
  introSubjectsWord: "fannoni",
...
const frTranslations: Translations = {
  ...
  resetIntro: "Saisissez l'e-mail utilisé à l'inscription. Si un compte existe, nous vous enverrons un lien pour choisir un nouveau mot de passe.",
  sendResetLink: "Envoyer le lien",
  resetLinkSentTitle: "Consultez vos e-mails",
  resetLinkSentBody: "Si un compte existe pour cette adresse, un lien pour choisir un nouveau mot de passe est en route. Le lien expire au bout d'une heure.",
  couldntSendResetLink: "Impossible d'envoyer le lien",
  backToSignIn: "Retour à la connexion",
  newPasswordTitle: "Choisir un nouveau mot de passe",
  newPasswordIntro: "Choisissez un nouveau mot de passe pour votre compte. Vous serez connecté dès qu'il sera enregistré.",
  ...
  passwordUpdatedBody: "Vous êtes connecté.",
  couldntUpdatePassword: "Impossible de mettre à jour le mot de passe",
  resetLinkInvalidTitle: "Ce lien a expiré",
  resetLinkInvalidBody: "Un lien de réinitialisation ne sert qu'une fois, et il cesse de fonctionner une heure après son envoi.",
  requestNewResetLink: "Demander un nouveau lien",
  checkingResetLink: "Vérification de votre lien",
  ...
  storyModeDesc: "Un parcours guidé à travers le Coran, puis le Hadith, puis la vie des Compagnons.",
  ...
  howItWorksLadderTitle: "Neuf niveaux, une catégorie à la fois",
  howItWorksLadderBody: "Chaque catégorie est une échelle de neuf niveaux, de Mubtadi à Mujaddid. Le niveau 1 est ouvert. Les huit autres restent verrouillés jusqu'à ce que vous les méritiez.",
  howItWorksClearingTitle: "Terminez un niveau pour ouvrir le suivant",
  howItWorksClearingBody: "Le niveau 1 compte {count} questions. Le niveau suivant ne s'ouvre qu'une fois que vous avez répondu correctement à toutes.",
  howItWorksRuleAll: "Les {count} questions, toutes justes",
  howItWorksRuleRetry: "Une erreur ? Refaites le niveau, aussi souvent que vous le voulez",
  ...
  roundReviewCorrectAnswer: "Bonne réponse",
  roundReviewNotAnswered: "Sans réponse",
  roundReviewTimedOutNote: "Le temps s'est écoulé : cette question n'a pas été corrigée, la réponse n'est donc pas affichée.",
  roundReviewShow: "Revoir toutes les questions",
  roundReviewHide: "Masquer la revue",
  ...
  introEyebrowThree: "Le rang",
  introTitleThree: "De {first} à {last}",
  introBodyThree: "Neuf rangs les séparent, gagnés un niveau à la fois. Et chaque réponse vous dit pourquoi, juste ou fausse. Ici, vous ne perdez pas. Vous apprenez.",
  introEnter: "Commencer la chasse",
  introSubjectsWord: "matières",
...
const arTranslations: Translations = {
  ...
  resetIntro: "أدخل البريد الإلكتروني الذي سجّلت به. إن كان هناك حساب، فسنرسل إليك رابطاً لتعيين كلمة مرور جديدة.",
  sendResetLink: "إرسال الرابط",
  resetLinkSentTitle: "تحقق من بريدك",
  resetLinkSentBody: "إن كان هناك حساب لهذا العنوان، فرابط تعيين كلمة مرور جديدة في طريقه إليك. ينتهي الرابط خلال ساعة.",
  couldntSendResetLink: "تعذّر إرسال الرابط",
  backToSignIn: "العودة إلى تسجيل الدخول",
  newPasswordTitle: "تعيين كلمة مرور جديدة",
  newPasswordIntro: "اختر كلمة مرور جديدة لحسابك. ستُسجَّل دخولك بمجرد حفظها.",
  newPasswordLabel: "كلمة المرور الجديدة",
  confirmPasswordLabel: "تأكيد كلمة المرور الجديدة",
  savePassword: "حفظ كلمة المرور",
  passwordsDoNotMatch: "كلمتا المرور غير متطابقتين.",
  passwordTooShort: "استخدم 6 أحرف على الأقل.",
  passwordUpdatedTitle: "تم تحديث كلمة المرور",
  passwordUpdatedBody: "أنت الآن مسجَّل الدخول.",
  couldntUpdatePassword: "تعذّر تحديث كلمة المرور",
  resetLinkInvalidTitle: "انتهت صلاحية هذا الرابط",
  resetLinkInvalidBody: "رابط إعادة التعيين يُستخدم مرة واحدة فقط، ويتوقف عن العمل بعد ساعة من إرساله.",
  requestNewResetLink: "اطلب رابطاً جديداً",
  checkingResetLink: "جارٍ التحقق من الرابط",
  ...
  storyMode: "وضع القصة",
  storyModeDesc: "مسار موجّه عبر القرآن، ثم الحديث، ثم سير الصحابة.",
  ...
  howItWorksLink: "كيف تسير اللعبة",
  howItWorksLadderTitle: "تسعة مستويات، فئة واحدة في كل مرة",
  howItWorksLadderBody: "كل فئة سُلَّم من تسعة مستويات، من المبتدئ إلى المجدِّد. المستوى الأول مفتوح، والثمانية الباقية مغلقة حتى تستحقها.",
  howItWorksClearingTitle: "أكمل مستوى ليُفتح الذي يليه",
  howItWorksClearingBody: "المستوى الأول فيه {count} سؤالاً. لا يُفتح المستوى التالي إلا بعد إجابتها كلها إجابة صحيحة.",
  howItWorksRuleAll: "الأسئلة الـ{count} كلها، بإجابات صحيحة",
  howItWorksRuleRetry: "أخطأت في سؤال؟ أعد المستوى، بقدر ما تشاء",
  ...
  roundReviewCorrectAnswer: "الإجابة الصحيحة",
  roundReviewNotAnswered: "بلا إجابة",
  roundReviewTimedOutNote: "نفد الوقت، فلم يُصحَّح هذا السؤال. لذلك لا تظهر إجابته.",
  roundReviewShow: "مراجعة كل الأسئلة",
  roundReviewHide: "إخفاء المراجعة",
  ...
  introEyebrowThree: "الرتبة",
  introTitleThree: "من {first} إلى {last}",
  introBodyThree: "تسع رتب تفصل بينهما، تُنال مستوى بعد مستوى. وكل إجابة تخبرك بالسبب، أصبت أم أخطأت. أنت لا تخسر هنا، بل تتعلم.",
  introEnter: "ابدأ الصيد",
  introSubjectsWord: "موضوعاً",
