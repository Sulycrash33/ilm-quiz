...
export interface Translations {
  ...
  forumNotLive: string
  mentorshipNotLive: string
  circlesWorkingNote: string
  forumThreadsNeed: string
  mentorMatchingNeed: string
  needBackendSuffix: string
...
const enTranslations: Translations = {
  ...
  forumNotLive: "The discussion forum isn't live yet",
  mentorshipNotLive: "Mentorship matching isn't live yet",
  circlesWorkingNote: "Study Circles are real and working - check that tab.",
  forumThreadsNeed: "Forum threads",
  mentorMatchingNeed: "Mentor matching",
  needBackendSuffix: "need their own backend before they can show real content here.",
...
const msTranslations: Translations = {
  ...
  forumNotLive: "Forum perbincangan belum aktif",
  mentorshipNotLive: "Padanan bimbingan belum aktif",
  circlesWorkingNote: "Kumpulan Belajar adalah sebenar dan berfungsi - semak tab itu.",
  forumThreadsNeed: "Utas forum",
  mentorMatchingNeed: "Padanan mentor",
  needBackendSuffix: "memerlukan backend sendiri sebelum dapat menunjukkan kandungan sebenar di sini.",
...
const idTranslations: Translations = {
  ...
  forumNotLive: "Forum diskusi belum aktif",
  mentorshipNotLive: "Pencocokan mentor belum aktif",
  circlesWorkingNote: "Kelompok Belajar nyata dan berfungsi - periksa tab itu.",
  forumThreadsNeed: "Utas forum",
  mentorMatchingNeed: "Pencocokan mentor",
  needBackendSuffix: "memerlukan backend sendiri sebelum dapat menampilkan konten nyata di sini.",
...
const haTranslations: Translations = {
  ...
  forumNotLive: "Dandalin tattaunawa ba ya aiki tukuna",
  mentorshipNotLive: "Daidaita shawara ba ya aiki tukuna",
  circlesWorkingNote: "Kungiyoyin Karatu na ainihi ne kuma suna aiki - duba wannan shafi.",
  forumThreadsNeed: "Zaren dandali",
  mentorMatchingNeed: "Daidaita mai ba da shawara",
  needBackendSuffix: "suna bukatar tsarin baya nasu kafin su nuna abun ciki na ainihi a nan.",
...
const frTranslations: Translations = {
  ...
  forumNotLive: "Le forum de discussion n'est pas encore actif",
  mentorshipNotLive: "La mise en relation avec un mentor n'est pas encore active",
  circlesWorkingNote: "Les cercles d'étude sont réels et fonctionnels - consultez cet onglet.",
  forumThreadsNeed: "Les fils de discussion",
  mentorMatchingNeed: "La mise en relation avec un mentor",
  needBackendSuffix: "nécessitent leur propre backend avant de pouvoir afficher du contenu réel ici.",
...
const arTranslations: Translations = {
  ...
  forumNotLive: "منتدى النقاش غير مفعّل بعد",
  mentorshipNotLive: "مطابقة الإرشاد غير مفعّلة بعد",
  circlesWorkingNote: "حلقات الدراسة حقيقية وتعمل - تحقق من تلك العلامة التبويب.",
  forumThreadsNeed: "مواضيع المنتدى",
  mentorMatchingNeed: "مطابقة المرشدين",
  needBackendSuffix: "تحتاج إلى بنية خلفية خاصة بها قبل أن تتمكن من عرض محتوى حقيقي هنا.",
